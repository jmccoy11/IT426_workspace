/*
  ...
  Date: 3/15/2018
  Filename: CircleAdapter.java

  The class creates a wrapper for a Circle shape to demonstrate using the adapter
...
public class CircleAdapter implements IShape {
    ...
    /**
     * Constructor
     * @param adaptee - Circle - object to wrap
     */
